...
# The source is void-code/install.ps1; the served copy is void-auth/public/vc/install.ps1, the one
# every `irm | iex` downloads. On every stable release void-code's release.yml copies
