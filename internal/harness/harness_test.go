...
// TestSpawnMissingBinary verifies Spawn rejects an untrusted relative path.
...
// TestSpawnEcho runs the absolute echo binary and checks Spawn returns nil.
func TestSpawnEcho(t *testing.T) {
	...
	if err != nil {
		t.Skip("echo binary unavailable")
	}
