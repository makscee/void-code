...
// The VCD-49 budget (pct/resetAt) and the VCD-56 top-level balanceUsd are
// retired from the client: Relay no longer sends pct/resetAt, and money now
// arrives as the `wallet` object (spec 2026-09-23-client-wallet-days). Their
// parse tests are gone; what replaces them is in me_wallet_test.go.
