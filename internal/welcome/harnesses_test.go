...
func TestSelectingMissingPiReturnsInstallAction(t *testing.T) {
	...
	m.harnesses.cursor = 1 // Pi (not installed)
	m2, _ = m.Update(tea.KeyMsg{Type: tea.KeyEnter})
	m = m2.(model)
