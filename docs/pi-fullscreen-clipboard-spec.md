...
| R6 | P0 gestures | Ctrl+C with Pi selection is consumed and copies; no selection retains normal interrupt/clear. Esc/up/down/ordinary input keep their existing Pi behavior. Successful native xterm Shift-selection copy and paste shortcuts are unchanged. |
